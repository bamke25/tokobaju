...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 27, 2021 at 11:23 AM
...
(9, 1, 'Kaos O-Neck', 'pcs', 0, 75000, '300', 'Nyaman dipakai sehari-hari', 'assets/img/sholat yuuk.jpg'),
(11, 3, 'Jaket Bomber', 'pcs', 0, 200000, '1000', 'Nyaman dipakai saat dingin', 'assets/img/sholat yuuk.jpg');
...
CREATE TABLE `tbl_alamat` (
  ...
  `sub_district_id` char(10) NOT NULL,
...
INSERT INTO `tbl_kota` (`id`, `province_id`, `name`) VALUES
...
INSERT INTO `tbl_provinsi` (`id`, `name`) VALUES
('11', 'ACEH'),
('12', 'SUMATERA UTARA'),
('13', 'SUMATERA BARAT'),
('14', 'RIAU'),
...
(4, 'Muhammad Jamalludin', 'jamal', '', '$2y$10$CHh1B3vp/AlQl/W3BLGEA.QwNOqCzKLcGaJVcUf9I82uj4okt89T.', 2, 0, 0);
...
ALTER TABLE `tbl_alamat`
  ADD PRIMARY KEY (`id`),
  ADD KEY `tbl_addresses_FK` (`sub_district_id`);
