<div class='container-fluid'>
  <div class='box box-info'>
    <h1 class="h4 mb-2 text-gray-800">Detail Profile</h1>
    <p class="mb-4">Menampilkan detail profile dan history belanja member di toko baju MasCitra.com</p>
              ...
              <table class='table table-condensed table-bordered'>
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><?= date('d F Y', $rows['date_created']); ?></td>
                  </tr>
                </tbody>
              </table>
                ...
                <tbody>
                  ...
                  foreach ($record->result_array() as $row) {
                    if ($row['proses'] == '0') {
                      ...
                      $proses = '<i class="text-info">Dikirim</i>';
                    } else {
